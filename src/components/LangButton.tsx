...
const LangButton = ({language, handleLanguage, ariaLabel}:LangButtonProps) => {
     
  return (
    <button onClick={handleLanguage} aria-label={ariaLabel} className="  h-8 overflow-hidden group focus-within:outline outline-primary  flex items-center justify-center fixed z-50 top-18 md:top-20 right-6 md:right-15  rounded-full  text-foreground/80 focus-visible:text-primary/70 group-focus-visible:text-primary/70  hover:text-primary/70  glass  focus-visible:backdrop-blur-md shadow-none  transition-all duration-200 ease-in ">
